...
\begin{frame}{Finding help}
	...
	\end{itemize}
\end{frame}
	This section to cover MATLAB's documentation, running example code from the help files and searching online
%http://uk.mathworks.com/matlabcentral/?s_tid=gn_mlc
% Section on finding help, using MATLAB tutorials in the help documentation, links to other resources, the programming course, software carpentry etc, but do not overload with info!
\end{document}