...
\begin{frame}{Before you get started}
	\begin{itemize}
		...
		\item The license supports 616 concurrent research users (and generally fewer licenses for MATLAB's toolboxes), so please:
		\begin{itemize}
...
\frame{\frametitle{MATLAB notation}\framesubtitle{The semicolon}
	\begin{itemize}
		...
		\includegraphics[scale=0.7]{semicolon}
...
\begin{frame}{Matrix operators}{Syntax}
	...
	\begin{itemize}
		...
		\item e.g. matrix multiply * versus array multiply .* (the dot is small, isn't it?)\\
